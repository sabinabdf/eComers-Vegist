                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>Details</td>
                                <td colspan="3">
                                    <textarea name="details" class="form-control" id="" cols="15" rows="5"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>Product Description</td>
                                <td colspan="3">
                                    <textarea name="product_description" class="form-control" id="" cols="15" rows="5"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>Price</td>
                                <td><input type="number" name="price" class="form-control"></td>
                                <td colspan="3"><input type="submit" value="Insert" class="btn btn-primary form-control"></td>
                            </tr>
                        </table>
                    </form>
                </div>
