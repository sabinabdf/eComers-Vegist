    ...
    <div class="main_content_iner overly_inner ">
        <div class="container-fluid p-0 ">
            <div class="row">
                ...
                <form action="<?php echo base_url('admin/Admin/update_product_category') ?>" method="post"
                    enctype="multipart/form-data">
                    <table class="table table-bordered">
                        <input type="hidden" value="<?php echo $category_list->id ?>" name="id">
                        <tr>
                            <td>Product Name</td>
                            <td><input type="text" name="name" class="form-control"
                                    value="<?php echo $category_list->name ?>"></td>
                            <td>Photo</td>
                            <td>

                                <input type="file" name="photo" class="form-control" >
                                <img src="<?php echo base_url('product/category/') ?><?php echo $category_list->photo ?>"
                                    style="width:15%">
                            </td>
