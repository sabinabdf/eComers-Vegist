                            ...
                            <div class="main-navigation navbar-expand-xl">
                                                ...
                                                <li class="menu-link parent">
                                                    ...
                                                    <ul class="dropdown-submenu banner-menu collapse" id="collapse-banner-menu1">
                                                        <li class="menu-banner">
                                                            <a href="grid-list.html" class="menu-banner-img"><img src="<?php echo base_url('FrontAssets/') ?>image/menu-banner01.jpg" alt="menu-image" class="img-fluid"></a>
                                                            <a href="grid-list.html" class="menu-banner-title"><span>Bestseller</span></a>
                                                        </li>
                                                        <li class="menu-banner">
                                                            <a href="grid-list.html" class="menu-banner-img"><img src="<?php echo base_url('FrontAssets/') ?>image/menu-banner02.jpg" alt="menu-image" class="img-fluid"></a>
                                                            <a href="grid-list.html" class="menu-banner-title"><span>Special product</span></a>
                                                        </li>
                                                        <li class="menu-banner">
                                                            <a href="grid-list.html" class="menu-banner-img"><img src="<?php echo base_url('FrontAssets/') ?>image/menu-banner03.jpg" alt="mneu image" class="img-fluid"></a>
                                ...
                                <div class="img-hotline">
                                    <div class="image-line">
                                        <a href="javascript:void(0)"><img src="<?php echo base_url('FrontAssets/') ?>image/icon_contact.png" class="img-fluid" alt="image-icon"></a>
                                    </div>
                        ...
                        <div class="home-category owl-carousel owl-theme">
                                ...
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/category-image/home-1/cat1.jpg" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/category-image/home-1/cat2.jpg" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/category-image/home-1/cat3.jpg" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/category-image/home-1/cat4.jpg" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/category-image/home-1/cat5.jpg" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/category-image/home-1/cat6.jpg" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/category-image/home-1/cat7.jpg" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/category-image/home-1/cat8.jpg" alt="cate-image">
                            ...
                            <div class="items">
                                <div class="h-cate">
                                    <div class="c-img">
                                        <a href="grid-list.html" class="home-cate-img">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/category-image/home-1/cat9.jpg" alt="cate-image">
                        ...
                        <div class="trending-products owl-carousel owl-theme">
                            <div class="items">
                                <div class="tred-pro">
                                    <div class="tr-pro-img">
                                        <a href="product.html">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-1.jpg" alt="pro-img1">
                                            <img class="img-fluid additional-image" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-01.jpg" alt="additional image">
                                        </a>
                                    </div>
                                    <div class="Pro-lable">
                            ...
                            <div class="items">
                                <div class="tred-pro">
                                    <div class="tr-pro-img">
                                        <a href="product.html">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-2.jpg" alt="pro-img1">
                                            <img class="img-fluid additional-image" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-02.jpg" alt="additional image">
                                        </a>
                                    </div>
                                    <div class="Pro-lable">
                                        <span class="p-text">New</span>
                            ...
                            <div class="items">
                                <div class="tred-pro">
                                    <div class="tr-pro-img">
                                        <a href="product.html">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-3.jpg" alt="pro-img1">
                                            <img class="img-fluid additional-image" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-03.jpg" alt="additional image">
                                        </a>
                                    </div>
                                    <div class="Pro-lable">
                            ...
                            <div class="items">
                                <div class="tred-pro">
                                    <div class="tr-pro-img">
                                        <a href="product.html">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-4.jpg" alt="pro-img1">
                                            <img class="img-fluid additional-image" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-04.jpg" alt="additional image">
                                        </a>
                                    </div>
                                    <div class="Pro-lable">
                                        <span class="p-text">New</span>
                            ...
                            <div class="items">
                                <div class="tred-pro">
                                    <div class="tr-pro-img">
                                        <a href="product.html">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-5.jpg" alt="pro-img1">
                                            <img class="img-fluid additional-image" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-05.jpg" alt="additional image">
                                        </a>
                                    </div>
                                    <div class="Pro-lable">
                            ...
                            <div class="items">
                                <div class="tred-pro">
                                    <div class="tr-pro-img">
                                        <a href="product.html">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-6.jpg" alt="pro-img1">
                                            <img class="img-fluid additional-image" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-06.jpg" alt="additional image">
                                        </a>
                                    </div>
                                    <div class="Pro-lable">
                            ...
                            <div class="items">
                                <div class="tred-pro">
                                    <div class="tr-pro-img">
                                        <a href="product.html">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-7.jpg" alt="pro-img1">
                                            <img class="img-fluid additional-image" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-07.jpg" alt="additional image">
                                        </a>
                                    </div>
                                    <div class="Pro-lable">
                            ...
                            <div class="items">
                                <div class="tred-pro">
                                    <div class="tr-pro-img">
                                        <a href="product.html">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-8.jpg" alt="pro-img1">
                                            <img class="img-fluid additional-image" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-08.jpg" alt="additional image">
                                        </a>
                                    </div>
                                    <div class="Pro-lable">
                                        <span class="p-text">New</span>
                            ...
                            <div class="items">
                                <div class="tred-pro">
                                    <div class="tr-pro-img">
                                        <a href="product.html">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-9.jpg" alt="pro-img1">
                                            <img class="img-fluid additional-image" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-09.jpg" alt="additional image">
                                        </a>
                                    </div>
                                    <div class="Pro-lable">
                                        <span class="p-discount">-12%</span>
                            ...
                            <div class="items">
                                <div class="tred-pro">
                                    <div class="tr-pro-img">
                                        <a href="product.html">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-10.jpg" alt="pro-img1">
                                            <img class="img-fluid additional-image" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-010.jpg" alt="additional image">
                                        </a>
                                    </div>
                                    <div class="Pro-lable">
                                        <span class="p-text">New</span>
                            ...
                            <div class="items">
                                <div class="tred-pro">
                                    <div class="tr-pro-img">
                                        <a href="product.html">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-11.jpg" alt="pro-img1">
                                            <img class="img-fluid additional-image" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-011.jpg" alt="additional image">
                                        </a>
                                    </div>
                                    <div class="Pro-lable">
                                        <span class="p-text">New</span>
                            ...
                            <div class="items">
                                <div class="tred-pro">
                                    <div class="tr-pro-img">
                                        <a href="product.html">
                                            <img class="img-fluid" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-12.jpg" alt="pro-img1">
                                            <img class="img-fluid additional-image" src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-012.jpg" alt="additional image">
                                        </a>
                                    </div>
                                    <div class="Pro-lable">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="h-t-pro">
                                                <div class="tred-pro">
                                                    <div class="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-4.jpg" alt="pro-img1" class="img-fluid">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-04.jpg" alt="additional image" class="img-fluid additional-image">
                                                        </a>
                                                    </div>
                                                    <div class="Pro-lable">
                                                        <span class="p-text">New</span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="h-t-pro">
                                                <div class="tred-pro">
                                                    <div class="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-7.jpg" alt="pro-img1" class="img-fluid">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-07.jpg" alt="additional image" class="img-fluid additional-image">
                                                        </a>
                                                    </div>
                                                    <div class="Pro-lable">
                                                        <span class="p-discount">-10%</span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="h-t-pro">
                                                <div class="tred-pro">
                                                    <div class="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-3.jpg" alt="pro-img1" class="img-fluid">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-03.jpg" alt="additional image" class="img-fluid additional-image">
                                                        </a>
                                                    </div>
                                                    <div class="Pro-lable">
                                                        <span class="p-discount">-20%</span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="h-t-pro">
                                                <div class="tred-pro">
                                                    <div class="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-1.jpg" alt="pro-img1" class="img-fluid">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-01.jpg" alt="additional image" class="img-fluid additional-image">
                                                        </a>
                                                    </div>
                                                    <div class="Pro-lable">
                                                        <span class="p-text">New</span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="h-t-pro">
                                                <div class="tred-pro">
                                                    <div class="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-5.jpg" alt="pro-img1" class="img-fluid">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-05.jpg" alt="additional image" class="img-fluid additional-image">
                                                        </a>
                                                    </div>
                                                    <div class="Pro-lable">
                                                        <span class="p-discount">-12%</span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="h-t-pro">
                                                <div class="tred-pro">
                                                    <div class="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-6.jpg" alt="pro-img1" class="img-fluid">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-06.jpg" alt="additional image" class="img-fluid additional-image">
                                                        </a>
                                                    </div>
                                                    <div class="Pro-lable">
                                                        <span class="p-discount">-21%</span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="h-t-pro">
                                                <div class="tred-pro">
                                                    <div class="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-8.jpg" alt="pro-img1" class="img-fluid">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-08.jpg" alt="additional image" class="img-fluid additional-image">
                                                        </a>
                                                    </div>
                                                    <div class="Pro-lable">
                                                        <span class="p-text">New</span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="h-t-pro">
                                                <div class="tred-pro">
                                                    <div class="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-9.jpg" alt="pro-img1" class="img-fluid">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-09.jpg" alt="additional image" class="img-fluid additional-image">
                                                        </a>
                                                    </div>
                                                    <div class="Pro-lable">
                                                        <span class="p-discount">-12%</span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="h-t-pro">
                                                <div class="tred-pro">
                                                    <div class="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-10.jpg" alt="pro-img1" class="img-fluid">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-010.jpg" alt="additional image" class="img-fluid additional-image">
                                                        </a>
                                                    </div>
                                                    <div class="Pro-lable">
                                                        <span class="p-text">New</span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="h-t-pro">
                                                <div class="tred-pro">
                                                    <div class="tr-pro-img">
                                                        <a href="product.html">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-2.jpg" alt="pro-img1" class="img-fluid">
                                                            <img src="<?php echo base_url('FrontAssets/') ?>image/pro/pro-img-02.jpg" alt="additional image" class="img-fluid additional-image">
                                                        </a>
                                                    </div>
                                                    <div class="Pro-lable">
                                                        <span class="p-text">New</span>
