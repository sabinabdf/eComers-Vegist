                                    ...
                                    <ul class="check-ul">
                                        <li>
                                            <div class="check-pro-img">
                                                <a href="product.html"><img src="<?php echo base_url('FrontAssets/') ?>image/pro-page-image/check-image-1.jpg" class="img-fluid" alt="image"></a>
                                            </div>
                                        ...
                                        <li>
                                            <div class="check-pro-img">
                                                <a href="product.html"><img src="<?php echo base_url('FrontAssets/') ?>image/pro-page-image/check-image-2.jpg" class="img-fluid" alt="image"></a>
                                            </div>
                                            <div class="check-content">
                                                <a href="product.html">Fresh healthy food</a>
                                                <span class="check-code-blod">Product code: <span>CA70051541B</span></span>
